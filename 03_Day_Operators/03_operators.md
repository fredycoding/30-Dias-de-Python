<div align="center">
  <h1> Curso Python: Curso 3 - Operadores</h1>
...
[<< Curso 2](../02_Day_Variables_builtin_functions/02_variables_builtin_functions.md) | [Curso 4 >>](../04_Day_Strings/04_strings.md)
...
Un dato booleano respresenta dos valores falso o verdadero: _True_ or _False_. El uso de estos valores siempre tienen que ir en mayúscula la primera letra . **T** para True y **F** para False.
...
Python soporta varios tipos de operadores y aqui vamos a analizar unos de ellos.
